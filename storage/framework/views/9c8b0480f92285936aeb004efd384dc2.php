                    ...
                    <div class="card-header mt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1 me-5">
                                ...
                                <form action="<?php echo e(route('fiche_de_paie.index')); ?>" method="GET">
                                    <!--end::Svg Icon--> <input type="text"
                                        class="form-control form-control-solid w-250px ps-15" name="q"
                                        placeholder="Chercher fiche">
                                </form>
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="<?php echo e(route('fiche_de_paie.create')); ?>" class="btn btn-light-primary">
                        ...
                        <table class="table table-bordered" style="width: 600px; height: 300px;">
                            <tbody>
                                <tr>
                                    ...
                                    <th style="width: 280px; text-align: center;">Nom </th>
                                    <th  style="width: 280px; text-align: center;">Mois</th>
                                    <th  style="width: 280px; text-align: center;">Salaire total</th>
                                    <th  style="width: 280px; text-align: center;">Salaire final</th>
                                ...
                                <?php $__currentLoopData = $fichesDePaie; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ficheDePaie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td style="width: 280px; text-align: center;">
                                            <span
                                                class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2 text-primary"><?php echo e($ficheDePaie->user->name); ?></span>
                                        </td>
                                        <td style="width: 280px; text-align: center;">
                                            <span
                                                class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2 text-primary"><?php echo e($ficheDePaie->month); ?></span>
                                        </td>
                                        <td style="width: 280px; text-align: center;">
                                            <span
                                                class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2 text-primary"><?php echo e($ficheDePaie->salaire_total); ?></span>
                                        </td>
                                        <td style="width: 280px; text-align: center;">
                                            <span
                                                class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2 text-primary"><?php echo e($ficheDePaie->salairefinal); ?></span>
                                        </td>
                                        <td style="width: 400px; text-align: center;">
                                            <a class="btn btn-light btn-active-primary my-1 me-2"
                                                href="<?php echo e(route('fiche_de_paie.show', $ficheDePaie->id)); ?>">Afficher</a>

                                            <a class="btn btn-light btn-active-primary my-1 me-2"
                                                href="<?php echo e(route('fiche_de_paie.edit', $ficheDePaie->id)); ?>">Modifier</a>
                                                <a class="btn btn-light btn-active-primary my-1 me-2"
                                                href="<?php echo e(route('fiche_de_paie.imprimer', $ficheDePaie->id)); ?>">Imprimer</a>
                                            <?php echo Form::open(['method' => 'DELETE', 'route' => ['fiche_de_paie.destroy', $ficheDePaie->id], 'style' => 'display:inline']); ?>
