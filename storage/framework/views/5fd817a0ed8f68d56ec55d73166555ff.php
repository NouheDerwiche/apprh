<?php $__env->startSection('content'); ?>
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        ...
        <div class=" container-xxl ">
                ...
                <div class="card-header mt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1 me-5">
                            ...
                            <form action="<?php echo e(route('projets.index')); ?>" method="GET" role="search">
                                <!--end::Svg Icon--> <input type="text"
                                    class="form-control form-control-solid w-250px ps-15" name="search" placeholder="Rechercher par titre" value="<?php echo e(request('search')); ?>">
                            </form>
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="<?php echo e(route('projets.create')); ?>" class="btn btn-light-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <!--end::Menu item-->
                                            <div class="menu-item px-3">
                                                <?php echo Form::open(['method' => 'DELETE', 'route' => ['projets.destroy', $projet->id], 'style' => 'display:inline']); ?>
                                            ...
                                            <script>
                                                function confirmDelete(event) {
                                                    ...
                                                    message.textContent = 'Êtes-vous sûr de vouloir supprimer cet projet ?';
            ...
            <?php echo e($projets->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('test.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\derwiche\apprh\resources\views/projets/index.blade.php ENDPATH**/ ?>