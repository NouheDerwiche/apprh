                ...
                <div class="row ">
                  ...
                  <div class="col-md-6 mb-3">
                    <div class="form-group">
                      ...
                      <?php echo Form::text('prenom', null, array('placeholder' => 'Prénom','class' => 'form-control')); ?>
...
<?php echo $__env->make('test.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\derwiche\apprh\resources\views/users/create.blade.php ENDPATH**/ ?>