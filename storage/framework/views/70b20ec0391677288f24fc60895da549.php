...
<?php endif; ?>
    ...
    <!--end::Svg Icon-->                <input type="text"  class="form-control form-control-solid w-250px ps-15" name="term" placeholder="chercher utilisateur" id="term">
    </form>
...
<?php echo $__env->make('test.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\derwiche\apprh\resources\views/users/index.blade.php ENDPATH**/ ?>