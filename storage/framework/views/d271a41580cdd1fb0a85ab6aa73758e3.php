...
<form class="form w-100" novalidate="novalidate" method="POST" action="<?php echo e(route('password.email')); ?> ">
    ...
    <div class="text-center mb-10">
        ...
        <div class="text-gray-400 fw-semibold fs-4">
            <?php echo e(__('Enter your email to reset your password.')); ?>
...
<?php endif; ?>
    ...
    <div class="flex items-center justify-end mt-4">
        ...
        <a href=<?php echo e(route('login')); ?> class="btn btn-lg btn-primary fw-bold me-4">Cancel</a>
    </div>
    </div>
</form>
            </div>
...
<?php /**PATH C:\xampp\htdocs\pfe\apprh\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>