...
<head>
    ...
    <link href="<?php echo e(asset('assets/plugins/custom/leaflet/leaflet.bundle.css')); ?>" rel="stylesheet" type="text/css">
...
<body id="kt_body"
                ...
                <div class="aside-menu flex-column-fluid px-4 px-lg-7">
                    ...
                    <div class="menu menu-sub-indention menu-column menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-active-bg menu-state-primary menu-arrow-gray-500 fw-semibold fs-6 my-5 mt-lg-2 mb-lg-0"
                        ...
                        <div class="hover-scroll-y me-lg-n5 pe-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="<?php echo e(route('conges.index')); ?>">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link--><a class="menu-link"
                                            href="<?php echo e(route('conges.index')); ?>"><span class="menu-bullet"><span
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link--><a class="menu-link"
                                            href="<?php echo e(route('conges.user')); ?>"><span class="menu-bullet"><span
                                                    class="bullet bullet-dot"></span></span><span
   ...
   <?php endif; ?>
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="<?php echo e(route('conges.user')); ?>">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/electronics/elc002.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <?php endif; ?>
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link--><a class="menu-link" href="<?php echo e(route('tache.index')); ?>"><span
                                        class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                                        <span class="svg-icon svg-icon-2"><svg width="24" height="24"
                                                viewbox="0 0 24 24" fill="none"
                    ...
                    <div class=" container-fluid  d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            ...
                            <a href="index.html" class="d-lg-none">
                                <img alt="Logo" src="<?php echo e(asset('assets/media/logos/logo-compact.svg')); ?>"
                                    class="mh-40px">
                            </a>
                            <!--end::Logo-->
                                ...
                                <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                        ...
                                        <div class="menu-item px-5">
                                            <a href="<?php echo e(route('profile.edit')); ?>" class="menu-link px-5">
                                                 profil
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
                                                ...
                                                <span class="menu-title position-relative">
                                                    ...
                                                    <span
                                                        ...
                                                        Français <img class="w-15px h-15px rounded-1 ms-2"
                                                            src="<?php echo e(asset('assets/media/flags/france.svg')); ?>"
                                                            alt="">
                                                    </span>
                                                </span>
                                            </a>
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                        src="<?php echo e(asset('assets/media/avatars/300-25.jpg')); ?>"></div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                    ...
                    <div class="d-flex justify-content-end mb-10 ">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                        src="<?php echo e(asset('assets/media/avatars/300-26.jpg')); ?>"></div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::User-->
...
-icon btn-active-light-primary" id="kt_drawer_shopping_cart_close">
            ...
            <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo e(asset('assets/media/stock/600x400/img-1.jpg')); ?>" alt="">
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo e(asset('assets/media/stock/600x400/img-3.jpg')); ?>" alt="">
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo e(asset('assets/media/stock/600x400/img-8.jpg')); ?>" alt="">
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo e(asset('assets/media/stock/600x400/img-26.jpg')); ?>" alt="">
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo e(asset('assets/media/stock/600x400/img-21.jpg')); ?>" alt="">
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo e(asset('assets/media/stock/600x400/img-34.jpg')); ?>" alt="">
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?php echo e(asset('assets/media/stock/600x400/img-27.jpg')); ?>" alt="">
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img alt="Logo" src="<?php echo e(asset('assets/media/svg/brand-logos/google-icon.svg')); ?>"
                            class="h-20px me-3">
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="<?php echo e(asset('assets/media/avatars/300-26.jpg')); ?>">
                                    </div>
                                    <!--end::Avatar-->
                                            ...
                                            <div class="mh-300px scroll-y me-n7 pe-7">
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic"
                                                                src="<?php echo e(asset('assets/media/avatars/300-6.jpg')); ?>">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic"
                                                                src="<?php echo e(asset('assets/media/avatars/300-26.jpg')); ?>">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic"
                                                                src="<?php echo e(asset('assets/media/avatars/300-5.jpg')); ?>">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic"
                                                                src="<?php echo e(asset('assets/media/avatars/300-25.jpg')); ?>">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic"
                                                                src="<?php echo e(asset('assets/media/avatars/300-9.jpg')); ?>">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic"
                                                                src="<?php echo e(asset('assets/media/avatars/300-23.jpg')); ?>">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic"
                                                                src="<?php echo e(asset('assets/media/avatars/300-12.jpg')); ?>">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic"
                                                                src="<?php echo e(asset('assets/media/avatars/300-13.jpg')); ?>">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic"
                                                                src="<?php echo e(asset('assets/media/avatars/300-21.jpg')); ?>">
                                                        </div>
                                                        <!--end::Avatar-->
                                            ...
                                            <div class="mh-300px scroll-y me-n7 pe-7">
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-35px">
                                                            <img src="<?php echo e(asset('assets/media/svg/files/pdf.svg')); ?>"
                                                                alt="icon">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-35px">
                                                            <img src="<?php echo e(asset('assets/media/svg/files/css.svg')); ?>"
                                                                alt="icon">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-35px">
                                                            <img src="<?php echo e(asset('assets/media/svg/files/ai.svg')); ?>"
                                                                alt="icon">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div class="d-flex flex-stack py-4 ">
                                                    <div class="d-flex align-items-center">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-35px">
                                                            <img src="<?php echo e(asset('assets/media/svg/files/tif.svg')); ?>"
                                                                alt="icon">
                                                        </div>
                                                        <!--end::Avatar-->
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="text-center px-4">
                                            <img
                                                src="<?php echo e(asset('assets/media/illustrations/sigma-1/9.png" alt=""
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div
                                                    ...
                                                    <img
                                                        src="<?php echo e(asset('assets/media/svg/card-logos/visa.svg" alt=""
                                                                                                                class="h-25px')); ?>">
                                                    <img
                                                        src="<?php echo e(asset('assets/media/svg/card-logos/mastercard.svg" alt=""
                                                                                                                class="h-25px')); ?>">
                                                    <img
                                                        src="<?php echo e(asset('assets/media/svg/card-logos/american-express.svg" alt=""
                                                                                                                class="h-25px')); ?>">
                                                </div>
                                                <!--end::Card logos-->
                                            </div>
                        ...
                        <div class="py-5">
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="<?php echo e(asset('assets/media/illustrations/sigma-1/1.png')); ?>"
    ...
    <script src="<?php echo e(asset('assets/plugins/custom/leaflet/leaflet.bundle.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/js/custom/utilities/modals/create-project/type.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/custom/utilities/modals/create-project/settings.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/custom/utilities/modals/create-project/budget.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/custom/utilities/modals/create-project/team.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/custom/utilities/modals/create-project/targets.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/custom/utilities/modals/create-project/files.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/custom/utilities/modals/create-project/complete.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/custom/utilities/modals/create-project/main.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/custom/utilities/modals/select-location.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\derwiche\apprh\resources\views/test/index.blade.php ENDPATH**/ ?>