                    ...
                    <div class=" container-fluid  d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            ...
                            <a href="index.html" class="d-lg-none">
                                <img alt="Logo" src="<?php echo e(asset('assets/media/logos/logo-compact.svg')); ?>" class="mh-40px">
                            </a>
                            <!--end::Logo-->
                            ...
                            <div class="d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="cursor-pointer symbol symbol-35px symbol-lg-35px"
                                        data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                        data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                        <img src="<?php echo e(asset('storage/assets/media/avatars/' . Auth::user()->avatar)); ?>" >                                    </div>
                                            ...
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bold d-flex align-items-center fs-5">
                                                        <?php echo e(Auth::user()->name); ?> <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2 text-primary">   <?php
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img alt="Logo" src="<?php echo e(asset('assets/media/svg/brand-logos/google-icon.svg')); ?>" class="h-20px me-3">
                                            ...
                                            <div class="mh-300px scroll-y me-n7 pe-7">
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-35px">
                                                            <img src="<?php echo e(asset('assets/media/svg/files/pdf.svg')); ?>" alt="icon">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-35px">
                                                            <img src="<?php echo e(asset('assets/media/svg/files/doc.svg')); ?>" alt="icon">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-35px">
                                                            <img src="<?php echo e(asset('assets/media/svg/files/css.svg')); ?>" alt="icon">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-35px">
                                                            <img src="<?php echo e(asset('assets/media/svg/files/ai.svg')); ?>" alt="icon">
                                                        </div>
                                                        <!--end::Avatar-->
                                                ...
                                                <div class="d-flex flex-stack py-4 ">
                                                    <div class="d-flex align-items-center">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-35px">
                                                            <img src="<?php echo e(asset('assets/media/svg/files/tif.svg')); ?>" alt="icon">
                                                        </div>
                                                        <!--end::Avatar-->
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="text-center px-4">
                                            <img src="<?php echo e(asset('assets/media/illustrations/sigma-1/9.png" alt=""
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="position-absolute translate-middle-y top-50 end-0 me-5')}}">
                                                    <img src="<?php echo e(asset('assets/media/svg/card-logos/visa.svg" alt=""
                                                        class="h-25px')); ?>">
                                                    <img src="<?php echo e(asset('assets/media/svg/card-logos/mastercard.svg" alt=""
                                                        class="h-25px')); ?>">
                                                    <img src="<?php echo e(asset('assets/media/svg/card-logos/american-express.svg" alt=""
                                                        class="h-25px')); ?>">
                                                </div>
                                                <!--end::Card logos-->
                                            </div>
                        ...
                        <div class="py-5">
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="<?php echo e(asset('assets/media/illustrations/sigma-1/1.png')); ?>" alt=""
