...
<!--end::Svg Icon-->                <input type="text"  class="form-control form-control-solid w-250px ps-15" name="search" placeholder="Search holidays" >
</form>
            ...
            <tbody >
                <?php $__currentLoopData = $holidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td >
                                ...
                                <a class="btn btn-light btn-active-primary my-1 me-2" href="<?php echo e(route('holidays.edit', $holiday->id)); ?>">Modifier</a>


                                <a class="btn btn-light btn-active-primary my-1 me-2" href="<?php echo e(route('holidays.show', $holiday->id)); ?>">Afficher</a>


                                <?php echo Form::open(['method' => 'DELETE','route' => ['holidays.destroy', $holiday->id],'style'=>'display:inline']); ?>
...
<?php echo $__env->make('test.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\derwiche\apprh\resources\views/holidays/index.blade.php ENDPATH**/ ?>