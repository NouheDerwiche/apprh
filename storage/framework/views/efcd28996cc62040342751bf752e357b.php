        ...
        <div class="">
            ...
            <form action="<?php echo e(route('users.index')); ?>" method="GET" role="search" >
                ...
                <div class="input-group" >
                    ...
                    <a href="<?php echo e(route('users.index')); ?>" class=" mt-1">
...
<!--begin::Add user-->
<a type="button" href="<?php echo e(route('users.create')); ?>" class="btn btn-primary"  >
    Ajouter utilisateur
</a>
...
<div class="card-body py-4">
    ...
    <td >
        ...
        <div class="d-flex flex-column">
            <a href="view.html" class="text-gray-800 text-hover-primary mb-1"><?php echo e($user->name); ?> <?php echo e($user->prenom); ?></a>
    ...
    <div class="menu-item px-3">
        ...
        <?php echo Form::submit('Delete', ['class' => 'menu-link px-3', 'onclick' => 'return confirmDelete(event)']); ?>
