                                                    ...
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img alt="" class="w-25px"
                                                                src="{{asset('assets/media/svg/brand-logos/aven.svg')}}">
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img class="w-25px" alt=""
                                                                src="{{asset('assets/media/svg/brand-logos/atica.svg')}}">
                                                        </span>
                                                    </div>
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex mb-6">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                    <img src="{{asset('assets/media/stock/600x400/img-17.jpg')}}" class="mw-100" alt="">
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex mb-6">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                    <img src="{{asset('assets/media/stock/600x400/img-10.jpg')}}" class="mw-100" alt="">
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex mb-6">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                    <img src="{{asset('assets/media/stock/600x400/img-1.jpg')}}" class="mw-100" alt="">
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex mb-">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
                                    <img src="{{asset('assets/media/stock/600x400/img-9.jpg')}}" class="mw-100" alt="">
                                </div>
                                <!--end::Symbol-->
