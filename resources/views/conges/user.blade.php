            ...
            <div class="card-header mt-6">
                ...
                <div class="card-title">
                    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                        <h1> Les demandes de  {{ auth()->user()->name }}  {{ auth()->user()->prenom }}</h1>
                    </div>
                    <!--begin::Search-->
                    <table>
                ...
                <div class=" container-xxl ">
                    ...
                    <form action="{{ route('conges.user') }}" method="GET" class="d-flex">
                        ...
                        <div class="form-group btn-sm  mb-3">
                            ...
                            <a href="{{ route('conges.user') }}" class="btn btn-sm mb-3 btn-secondary">Réinitialiser</a>
                        </div>
                    </form>
                </div>
            ...
            <div class="card card-flush ">
                ...
                <div class="card-header mt-6">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('conges.create') }}" class="btn btn-light-primary">
                                    ...
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <a href="{{ route('conges.edit', $conge->id) }}" class="menu-link px-3">

                                                    Modifier
                                                </a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a href="{{ route('conges.show', $conge->id) }}" class="menu-link px-3">
                                                    Afficher
                                                </a>
                                            </div>
                                            ...
                                            <!--end::Menu item-->
                                            <div class="menu-item px-3">
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['conges.destroy', $conge->id], 'style' => 'display:inline']) !!}
