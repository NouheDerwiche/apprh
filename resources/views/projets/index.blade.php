                ...
                <div class="card-header mt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1 me-5">
                            ...
                            <form action="{{ route('projets.index') }}" method="GET" role="search">
                                <!--end::Svg Icon--> <input type="text"
                                    class="form-control form-control-solid w-250px ps-15" name="search" placeholder="Rechercher par titre" value="{{ request('search') }}">
                            </form>
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('projets.create') }}" class="btn btn-light-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <!--end::Menu item-->
                                            <div class="menu-item px-3">
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['projets.destroy', $projet->id], 'style' => 'display:inline']) !!}
                                                {!! Form::submit('Supprimer', ['class' => 'menu-link px-3', 'onclick' => 'return confirmDelete(event)']) !!}
                                                {!! Form::close() !!}
