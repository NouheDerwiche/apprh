                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="{{ url('employee/profile/'.$items->user_id) }}" class="avatar"><img alt="" src="{{ URL::to('/assets1/images/'. $items->avatar) }}" alt="{{ $items->name }}"></a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="pull-right">
                        ...
                        <h5 class="btn btn-primary">Add leave</h5>
