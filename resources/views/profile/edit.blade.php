                                        ...
                                        <div class="d-flex align-items-start flex-wrap">
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <a href="#"
                                                        class="text-gray-400 text-hover-primary fs-6 fw-semibold mb-5">{{ Auth::user()->email }}</a>
                                                    <div
                                        ...
                                        <div class="d-flex flex-wrap align-items-center">
                                            ...
                                            <div id="kt_signin_email">
                                                ...
                                                <form id="kt_signin_change_email" method="post"
                                                    ...
                                                    <div class="d-flex">
                                                        <x-primary-button class="btn btn-primary">{{ __('Modifier') }}
                                                        </x-primary-button>

                                                        @if (session('status') === 'profile-updated')
                                                            <p x-data="{ show: true }" x-show="show" x-transition
                                                                x-init="setTimeout(() => show = false, 2000)" class="text-sm text-gray-600">
                                                                {{ __('Votre mail a eté modifier.') }}</p>
                                                        @endif
                                                    </div>
                                                </form>
                                                <!--end::Form-->
                                                ...
                                                <form id="kt_signin_change_password"method="post"
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        @if (session('status') === 'password-updated')
                                                            <p x-data="{ show: true }" x-show="show" x-transition
                                                                x-init="setTimeout(() => show = false, 2000)" class="text-sm text-gray-600">
                                                                {{ __('Votre mot de passe a eté modifier.') }}</p>
                                                        @endif
                                        ...
                                        <div class="card-body border-top p-9">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="avatar" style="color: rgb(29, 115, 244)"
                                                    class=" form-control-lg form-control-solid @error('avatar') is-invalid @enderror" />
                                                @error('avatar')
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <x-text-input id="cin" name="cin" type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        :value="old('cin', $user->cin)" required autofocus autocomplete="cin" />
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <x-text-input id="ville" name="ville" type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        :value="old('ville', $user->ville)" required autofocus autocomplete="ville" />
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <x-text-input id="codepostal" name="codepostal" type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        :value="old('codepostal', $user->codepostal)" required autofocus autocomplete="codepostal" />
